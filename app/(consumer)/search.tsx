...
import { EventCard, EventCardSkeleton } from "../../src/components/discovery/EventCard";
...
import { DEMO_NOW_ISO, discoveryCategories } from "../../src/fixtures/discovery";
import { SearchResultTab } from "../../src/domain/discovery";
...
export default function SearchScreen() {
  ...
  const searchQuery = useDiscoverySearchQuery(debouncedQuery, filters);
  ...
  const isQueryEmpty = debouncedQuery.trim().length === 0 && activeFiltersCount === 0;
        ...
        <View style={styles.resultsContainer}>
          ...
          {searchQuery.isLoading ? (
            ...
            <FlatList
              ...
              ListEmptyComponent={
                <View style={styles.emptyState}>
                  <Icon name="mapPin" size={32} color={theme.colors.textMuted} />
                  <AppText variant="heading" style={styles.emptyTitle}>
